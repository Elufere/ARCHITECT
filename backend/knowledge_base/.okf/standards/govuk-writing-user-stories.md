...
TheRegister to vote service’suser story is ‘as a UK resident, I want to get my details on the electoral register so that I can vote’.

You can use a different format, but you should always briefly explain the actor, the narrative and the goal.
...
The acceptance criteria for the Register to vote service are:
...
Large user stories (ones that would take more than a few weeks to develop and test) are typically called epics. If possible, split a large story or epic into smaller stories that can be completed withinan iteration.

## How to record user stories

Record each user story on a card and give it a title. The cards can be:

- digital - for example, using tools like Trello or Pivotal Tracker
- actual cards posted on a wall

Use a format that works for everyone in your team. For example, if you use a physical wall, you’ll usually need to transfer them to a digital tool afterwards so that people can access them remotely.

### Planning with your user stories

When you have a lot of stories, you might want to keep them in a digital tool like Trello or a spreadsheet.
...
1. 5 January 2016Guidance first published
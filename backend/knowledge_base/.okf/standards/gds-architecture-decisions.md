...
Nygard ina blog postand since adopted widely. That post describes the format in full, but as a
...
Amazon Web Services (AWS) also provideuseful adviceabout how and why the ADR process should be adopted.
...
ADR in themainbranch of your GitHub repository is accepted.
...
This page was last reviewed on 5 March 2026.

        It needs to be reviewed again on 5 September 2026
        by the page owner
[#gds-way](https://gds.slack.com/messages/gds-way)
.
This page was set to be reviewed before 5 September 2026
       by the page owner
[#gds-way](https://gds.slack.com/messages/gds-way)
.

...
1. Anobjectsuch as an account, document, support ticket, transaction or partner profile.
2. Areferenceto that object in the form of an ID, UUID, account number, token or slug.
3. Amissing object-level authorization checkthat allows a user to access or manipulate an object they should not be able to access.

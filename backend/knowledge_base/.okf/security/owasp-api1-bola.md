...
| --- | --- | --- |
| API Specific : ExploitabilityEasy | PrevalenceWidespread: DetectabilityEasy | TechnicalModerate: Business Specific |
...
endpoint/function they should not have access to - this is a case ofBroken
Function Level Authorization(BFLA) rather than BOLA.
